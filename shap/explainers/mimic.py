import logging
from ..utils._legacy import match_model_to_data, convert_to_link, convert_to_model, convert_to_data, IdentityLink, DenseData
...
class MimicExplainer(Explainer):
    ...
    def __init__(self, model, data, mimic_model="xgboost", mimic_model_params={}, link = IdentityLink(), **kwargs):
    ...
    def _train_mimic_model(self):
        if self.mimic_model_type == "xgboost":
            self.mimic_model = xgboost.train(self.mimic_model_params, xgboost.DMatrix(self.data))
